...
Приложение **симулирует трафик** каждые 1.5 секунды, заполняя HTTP Log и таблицу Proxy реалистичными записями.  
Кнопка **⏸ Pause** на вкладке HTTP Log останавливает поток.  
Кнопка **Start Scan** на вкладке Scanner генерирует 8 тестовых уязвимостей.
